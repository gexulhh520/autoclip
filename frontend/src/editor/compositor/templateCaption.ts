...
export function buildOverlayLayoutConfig(
  ...
  return {
    ...
    headline_shadow: config.headline_shadow as number | undefined,
    body_shadow: config.body_shadow as number | undefined,
    headline_outline: config.headline_outline as number | undefined,
    role_styles: config.role_styles as Record<string, Record<string, unknown>> | undefined,
