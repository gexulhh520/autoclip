...
export function getTextBackgroundRect({
	...
	const paddingX =
		(background.paddingX ?? OPENCUT_TEXT_DEFAULTS.background.paddingX) * fontSizeRatio;
	const paddingY =
		(background.paddingY ?? OPENCUT_TEXT_DEFAULTS.background.paddingY) * fontSizeRatio;
	const offsetX = background.offsetX ?? OPENCUT_TEXT_DEFAULTS.background.offsetX;
	const offsetY = background.offsetY ?? OPENCUT_TEXT_DEFAULTS.background.offsetY;
