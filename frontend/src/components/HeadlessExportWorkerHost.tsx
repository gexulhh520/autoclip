...
import { useHeadlessExportNotifications } from '../hooks/useHeadlessExportNotifications'
...
export default function HeadlessExportWorkerHost() {
  ...
  useHeadlessExportNotifications()
  ...
  useEffect(() => {
    ...
    void refreshJobs().then(() => {
      if (useHeadlessExportWorkerStore.getState().activeJobCount() > 0) {
