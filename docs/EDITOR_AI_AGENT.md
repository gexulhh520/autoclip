...
> **更新**：2026-06-15（§5.1 补充 gemma4 工具调用）· **口播生产线**见 [VOICEOVER_PIPELINE.md](VOICEOVER_PIPELINE.md)（含 §15 端到端验收清单）  
...
| **口播生产线** | 分段脚本 → TTS → 对齐字幕 → 搜素材 → 智能选段；A/B/C 已落地，验收见 [VOICEOVER_PIPELINE.md §15](VOICEOVER_PIPELINE.md#15-端到端验收清单) |
